...
Phase: 06 (security-and-cryptography) — CODE+TEST+GATE COMPLETE, NOT YET
  VERIFIED (4 of 4 plans done: 06-01, 06-02, 06-03, 06-04. See
  .planning/phases/06-security-and-cryptography/06-04-SUMMARY.md.
  ...
  and refreshes the knowledge graph (06-96). NEXT: /gsd:verify-work 6
  (tick ROADMAP.md Phase 6 + docs/phases/phase-6/TODO.md, confirm the
  phase triplet exists), then plan Phase 7
  (reporting-and-visualization-shell).)
