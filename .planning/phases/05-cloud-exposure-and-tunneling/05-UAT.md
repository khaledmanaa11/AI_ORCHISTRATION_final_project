...
- truth: "the phase's own evidence and trackers describe exactly what happened -- no overclaim (rule 38)"
  ...
  missing:
    ...
    - "decide and record whether rules 15/21 require a TRANSMITTED declaration beyond the structural reveal; if yes, wire declare_truthfully into the turn path -- this is a rules-compliance question for the book, not a refactor, and belongs in its own plan"
